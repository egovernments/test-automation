...
Background:
  ...
  * def credentials = read('../../core-services/constants/user.yaml')
  * def employeeSuperUserUserNme = credentials.superuser.name
  *	def employeeSuperUserPassword = credentials.superuser.password
