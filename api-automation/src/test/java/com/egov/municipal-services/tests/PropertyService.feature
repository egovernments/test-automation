Feature: Property Services
    ...
    @Property_create_01 @createProperty @propertyServiceCreate @positive @regression @propertyServices @municipalServices @r2dot6updated @r2dot6
    Scenario: Create Property with valid payload
        ...
        * match propertyId == "#present"
        * match propertyServiceResponseBody.Properties[0].status == "INWORKFLOW"
        * match propertytenantId == tenantId
        * match alternatemobileNumber == "#present"
        * match alternatemobileNumber == mobileNumber
        * match alternatemobileNumberDetails == "#present"
        * match alternateUpdated == "#present"
    ...
    @Property_search_01 @Property_search_PropertyIds_07 @positive @propertyServiceSearch @regression @propertyServices @municipalServices @r2dot6updated @r2dot6
    ...
    @Property_Update_01 @positive @propertyServiceUpdate @regression @propertyServices @municipalServices @r2dot6updated @r2dot6
    ...
    @Property_search_By_Valid_PTDetails @positive @propertyServiceSearch @regression @propertyServices @municipalServices @digit_2_7 @Property_search_By_PTDetails
    Scenario: Search Property with valid property details
        # Create a property
        * call read('../../municipal-services/pretests/propertyServicesPretest.feature@createPropertySuccessfully')
        # Initializing search query params
        * def searchPropertyParams = { tenantId: '#(tenantId)', doorNo:'#(doorNo)', name:'#(ownerName)', locality:'#(locality)'}
        # Search a property
        * call read('../../municipal-services/pretests/propertyServicesPretest.feature@searhByPTIDSuccessfully')
        # Validate response body
        * match propertyServiceResponseBody.Properties[0].id == "#present"
        * match propertyServiceResponseBody.Properties[0].propertyId == "#present"
        * match propertyServiceResponseBody.Properties[0].status == "INWORKFLOW"
    ...
    @Property_search_By_PTDetails_without_locality @negative @propertyServiceSearch @regression @propertyServices @municipalServices @digit_2_7 @Property_search_By_PTDetails
    Scenario: Search Property without locality
        # Initializing search query params
        * def searchPropertyParams = { tenantId: 'abc', doorNo:'abc', name:'abc'}
        # Search a property
        * call read('../../municipal-services/pretests/propertyServicesPretest.feature@searchByPTDetailsError')
        # Validate response body
        * match propertyServiceResponseBody.Errors[0].message == propertyServicesConstants.errorMessages.noLocalityOpenSearch

    @Property_search_By_PTDetails_Error @negative @propertyServiceSearch @regression @propertyServices @municipalServices @digit_2_7 @Property_search_By_PTDetails
    Scenario: Search Property with invalid property details
        # Initializing search query params
        * def searchPropertyParams = { tenantId: 'abc', propertyIds: 'abc', doorNo:'doorNo', name:'ownerName', locality:'locality'}
        # Search a property
        * call read('../../municipal-services/pretests/propertyServicesPretest.feature@searchPropertyForEmptyResult')
        # Validate response body
        * match propertyServiceResponseBody.Properties.size() == 0