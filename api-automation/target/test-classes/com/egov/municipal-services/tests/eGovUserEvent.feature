...
Background:
    ...
    * def description = eGovUserEventConstants.events.description
    ...
    @notifications_count_01 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventNotification
    ...
    * match notificationResponseBody.totalCount == '#present'
    ...
    @notifications_noTenant_02 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventNotification
    ...
    * match notificationResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.withoutTenantID
    ...
    @events_create_PT_01 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventCreate
    ...
    * match eGovUserEventResponseBody.events[0].tenantId == '#present'
    ...
    @events_InvalidEventType_02 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventCreate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.invalidEventType
    ...
    @events_InvalidSource_03 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventCreate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.withoutTenantID
    ...
    @events_nullValues_04 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventCreate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.withoutTenantID
    ...
    @events_InValid_ToUser_05 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventCreate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.invalidUUIID
    ...
    @events_Wrong_EventType_06 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventCreate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.wrongEventType
    ...
    @events_update_01 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.events[0].tenantId == "#present"
    ...
    @events_Update_InvalidEventType_02 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.invalidEventType
    ...
    @events_Update_InvalidSource_03 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.withoutTenantID
    ...
    @events_update_nullValues_04 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.withoutTenantID
    ...
    @events_update_InvalidID_05 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.invalidEventId
    ...
    @events_update_Invalid_status_06 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.invalidStatus
    ...
    @events_update_InValid_ToUser_07 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.invalidUUIID
    ...
    @events_search_01 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventSearch
    ...
    * match eGovUserEventResponseBody.events[0].tenantId == '#present'
    ...
    @events_search_without_tenant_02 @negative @regression @municipalServices @eGovUserEvent @eGovUserEventSearch
    ...
    * match eGovUserEventResponseBody.Errors[0].message == eGovUserEventConstants.errorMessages.withoutTenantID
    ...
    @events_search_InvalidValues_03 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventSearch
    ...
    * match eGovUserEventResponseBody.events[0] == '#notpresent'
    ...
    @lat_update_01 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventLatUpdate
    ...
    * match eGovUserEventResponseBody.status == commonConstants.expectedStatus.success
    ...
    @events_create_02 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventCreate @r2dot6
    Scenario: Verify create an Event
    * call read('../../municipal-services/pretests/eGovUserEventPretest.feature@createEventsSuccessfully')
    * match eGovUserEventResponseBody.events[0].tenantId == '#present'

    @events_search_02 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventSearch @r2dot6
    Scenario: Verify searching for Egov user event service
    * call read('../../municipal-services/pretests/eGovUserEventPretest.feature@creatEventsSuccessfully')
    * def getEgovUserEventSearchParam = {"tenantId": '#(tenantId)',"source": '#(source)'}
    * call read('../../municipal-services/pretests/eGovUserEventPretest.feature@searchEventsSuccessfully')
    * match eGovUserEventResponseBody.events[0].tenantId == '#present'

    @events_update_02 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventUpdate @r2dot6
    Scenario: Update Egov User Event service
    * call read('../../municipal-services/pretests/eGovUserEventPretest.feature@createEgovUserEventSuccessfully')
    * def eGovUserEventBody = eGovUserEventResponseBody.events[0]
    * call read('../../municipal-services/pretests/eGovUserEventPretest.feature@updateEgovUserEventSuccessfully')
    ...
    * match eGovUserEventResponseBody.events[0].tenantId == "#present"
    ...
    @events_delete_02 @positive @regression @municipalServices @eGovUserEvent @eGovUserEventCreate @r2dot6
    Scenario: Verify deleting an Event
    * call read('../../municipal-services/pretests/eGovUserEventPretest.feature@deleteEventsSuccessfully')
    * match eGovUserEventResponseBody.events[0].tenantId == '#present'
