...
@IdGen_Generate_01 @coreServices @regression @positive @idGenerate
...
@IdGen_GeneratetMulti_02 @coreServices @regression @positive @idGenerate
...
@IdGen_switchIdName_03 @coreServices @regression @positive @idGenerate
...
@IdGen_invalidTenantId_04 @coreServices @regression @negative @idGenerate
Scenario: Test by passing a invalid or a nonexistent tenant id
    ...
    * assert idGenerateResponseBody.Errors[0].message == commonConstants.errorMessages.nonexistentTenantIdError

@IdGen_BlankFormat_06 @coreServices @regression @negative @idGenerate
...
@IdGen_InvalidSeqFormat_07 @coreServices @regression @negative @idGenerate
