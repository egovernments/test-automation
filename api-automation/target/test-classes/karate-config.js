   ...
   if(karate.properties['useKafkaSimulation']){
    ...
    config.kafkaHost = envProps.host
       ...
       //  username & password for Architect Employee user
        ...
        config.escalateCountURL = envProps.host + path.endPoints.escalate.escalateCount
        //billing service
        ...
        config.searchbparegURL = envProps.host + path.endPoints.bpaService.bparegSearch
        // BPA- Calculator
        ...
        //eDCR-Services
        config.scrutinizeUrl = envProps.host + path.endPoints.edcrServices.scrutinize
        config.scrutinydetailsUrl = envProps.host + path.endPoints.edcrServices.scrutinydetails
        config.occomparisonUrl = envProps.host + path.endPoints.edcrServices.occomparison
        ...
        config.deleteEgovUserEvent = envProps.host + path.endPoints.eGovUserEvent.delete
        ...
        //Documents
        config.createDocumentsURL = envProps.host + path.endPoints.documents.create
        config.updateDocumentsURL = envProps.host + path.endPoints.documents.update
