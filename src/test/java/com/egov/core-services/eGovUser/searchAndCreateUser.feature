...
@User_Search_ValidUserName_01  @positive  @user1
...
@User_Search_InValidUsername_02  @negative  @user1
...
@User_Search_InValidTenantId_03  @negative  @user1
...
@User_Search_NoUserName_04  @negative  @user1
...
@User_Search_NotenantId_05  @negative  @user1
...
@User_SearchMultipleTenantUsers_08  @positive  @user1
...
@User_SearchBlankTenant_09  @negative  @user1
...
@Create_Citizen_InValidOTP_02  @negative  @user1
...
@Create_Citizen_NoUsername_03 @negative  @user1
...
@Create_Citizen_NoName_04  @negative  @user1
...
@Create_Citizen_NotenantId_05  @negative  @user1
...
@Create_Citizen_InvalidUsername_06  @negative  @user1
...
@Create_Citizen_NameWithMoreThan50Characters_07  @negative  @user1
