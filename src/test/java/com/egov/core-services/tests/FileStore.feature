...
Background:
  ...
  * def fileStoreConst = read('../../core-services/constants/fileStore.yaml')
  ...
  @FileStore_GenerateId_01  @coreServices @positive  @fileStore
  ...
  @FileStore_MandatoryCheck_POST_02  @coreServices @negative  @fileStore
  ...
  @FileStore_invalidFiles_03  @coreServices @negative  @fileStore
  ...
  @FileStore_FetchDocPath_05   @coreServices @positive  @fileStore
  ...
  @FileStore_multipledocuments_06  @coreServices @positive  @fileStore
  ...
  @FileStore_NoTenantID_07  @coreServices @negative  @fileStore
  ...
  @FileStore_NoFilestoreID_08   @coreServices @negative  @fileStore
  ...
  @FileStore_E2E_09   @coreServices @positive  @fileStore
  ...
  @FileStore_noTenantModule_10  @coreServices @positive  @fileStore
  ...
  @FileStores_MultipleFiles_11  @coreServices @positive  @fileStore
  ...
  @FileStores_LargeFile_12  @coreServices @negative  @fileStore_broken_pipe
