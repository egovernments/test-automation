...
@Process_Transition_01  @positive  @egovWorkflowBusinessService @coreServicesDontRun
...
@Process_Transition_ActionError_02  @negative  @egovWorkflowBusinessService @coreServicesDontRun
...
@Process_Transition_NoModName_03  @negative  @egovWorkflowBusinessService @coreServicesDontRun
...
@Process_Transition_InValidTenanId_04  @negative  @egovWorkflowBusinessService @coreServicesDontRun
...
@Process_Transition_BusSerError_05  @negative  @egovWorkflowBusinessService @coreServicesDontRun
Scenario: Verify by passing a invalid/non existant /null Business Service and check for errors
  # * def businessService = 
  * call read('../../core-services/pretests/eGovWorkFlowProcessTransition.feature@processTransitionFail') 
   

#@Process_Transition_InvalidBusId_06  @negative  @egovWorkflowBusinessService @coreServicesDontRun
#Scenario: Verify by passing a invalid/non existant /null Business Service and check for errors

#@Process_Transition_NotAuthorised_07  @negative  @egovWorkflowBusinessService @coreServicesDontRun
