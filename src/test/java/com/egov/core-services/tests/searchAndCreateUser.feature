...
Scenario: Test to Search for user by passing valid UserName in the request
 ...
 @User_Search_InValidUsername_02  @coreServicesDontRun @regression @negative  @userSearch  @eGovUser
...
@User_Search_InValidTenantId_03  @coreServicesDontRun @regression @negative  @userSearch  @eGovUser
...
@User_Search_NoUserName_04  @coreServicesDontRun @regression @negative  @userSearch  @eGovUser
...
@User_Search_NotenantId_05  @coreServicesDontRun @regression @negative  @userSearch  @eGovUser
...
@User_SearchMultipleTenantUsers_08  @coreServicesDontRun @regression @positive  @userSearch  @eGovUser
...
@User_SearchBlankTenant_09  @coreServicesDontRun @regression @negative  @userSearch  @eGovUser
...
@Create_Citizen_InValidOTP_02  @coreServicesDontRun @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NoUsername_03 @coreServicesDontRun @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NoName_04  @coreServicesDontRun @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NotenantId_05  @coreServicesDontRun @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_InvalidUsername_06  @coreServicesDontRun @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NameWithMoreThan50Characters_07  @coreServicesDontRun @regression @negative  @createSearch  @eGovUser
