...
@User_Search_ValidUserName_01  @regression @positive  @userSearch  @eGovUser
Scenario: Test to Search for user by passing valid UserName in the request
 ...
 @User_Search_InValidUsername_02  @regression @negative  @userSearch  @eGovUser
...
@User_Search_InValidTenantId_03  @regression @negative  @userSearch  @eGovUser
...
@User_Search_NoUserName_04  @regression @negative  @userSearch  @eGovUser
...
@User_Search_NotenantId_05  @regression @negative  @userSearch  @eGovUser
...
@User_SearchMultipleTenantUsers_08  @regression @positive  @userSearch  @eGovUser
...
@Create_Citizen_InValidOTP_02  @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NoUsername_03 @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NoName_04  @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NotenantId_05  @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_InvalidUsername_06  @regression @negative  @createSearch  @eGovUser
...
@Create_Citizen_NameWithMoreThan50Characters_07  @regression @negative  @createSearch  @eGovUser
