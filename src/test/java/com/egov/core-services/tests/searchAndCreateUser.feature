...
@User_Search_ValidUserName_01  @coreServices @positive  @userSearch  @eGovUser
Scenario: Test to Search for user by passing valid UserName in the request
 ...
 @User_Search_InValidUsername_02  @coreServices @negative  @userSearch  @eGovUser
...
@User_Search_InValidTenantId_03  @coreServices @negative  @userSearch  @eGovUser
...
@User_Search_NoUserName_04  @coreServices @negative  @userSearch  @eGovUser
...
@User_Search_NotenantId_05  @coreServices @negative  @userSearch  @eGovUser
...
@User_SearchMultipleTenantUsers_08  @coreServices @positive  @userSearch  @eGovUser
...
@User_SearchBlankTenant_09  @coreServices @negative  @userSearch  @eGovUser
...
@Create_Citizen_InValidOTP_02  @coreServices @negative  @createSearch  @eGovUser
...
@Create_Citizen_NoUsername_03 @coreServices @negative  @createSearch  @eGovUser
...
@Create_Citizen_NoName_04  @coreServices @negative  @createSearch  @eGovUser
...
@Create_Citizen_NotenantId_05  @coreServices @negative  @createSearch  @eGovUser
...
@Create_Citizen_InvalidUsername_06  @coreServices @negative  @createSearch  @eGovUser
...
@Create_Citizen_NameWithMoreThan50Characters_07  @coreServices @negative  @createSearch  @eGovUser
