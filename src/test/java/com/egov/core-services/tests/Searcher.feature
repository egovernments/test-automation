...
@Searcher_Bill_01 @regression @positive @Searcher
...
@Searcher_InvalidReqUrl_02 @regression @negative @Searcher
Scenario: Test searching for a bill using egov searcher API service
...
@Searcher_InvalidTenant_03 @regression @negative @Searcher
...
@Searcher_Mandatory_04 @regression @negative @Searcher
...
@Searcher_MultipleSearch_06 @regression @negative @Searcher
...
@Searcher_NullMobile_07 @regression @negative @Searcher
...
@Searcher_NullBusinessSer_08 @regression @negative @Searcher
...
@Searcher_NullUrl_09 @regression @negative @Searcher
