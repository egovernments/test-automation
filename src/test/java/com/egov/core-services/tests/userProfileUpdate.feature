...
Background:
        ...
        * def invalidGender = randomNumber(3)
        ...
        @User_Update_ValidDataWithNameEmailCity_01 @coreServicesDontRun @regression @positive @updateProfile @eGovUser
        ...
        * assert hrmsResponseBody.Employees[0].user.correspondenceCity == city
        ...
        @User_Update_ValidDataWithAlltheParameters_02 @coreServicesDontRun @regression @positive @updateProfile @eGovUser
        ...
        * assert hrmsResponseBody.Employees.size() > 0
        ...
        @User_Update_NameWithSpecialCharacters_03 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == errorMessage.errormessages.invalidUserName
        ...
        @User_Update_InvalidEmail_04 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == errorMessage.errormessages.invalidEmail
        ...
        @User_Update_InvalidMobileNumber_05 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == errorMessage.errormessages.invalidPhoneNumber
        ...
        @User_Update_RandomDigit_MobileNumber_06 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert hrmsResponseBody.Employees[0].user.mobileNumber != randomMobileNo 
        ...
        @User_Update_InvalidGender_07 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == errorMessage.errormessages.invalidGender
        ...
        @User_Update_noTenantId_08 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == genericError.errorMessages.unhandledException
        ...
        @User_Update_noUUID_09 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].description == errorMessage.errormessages.invalidUUID
        ...
        @User_Update_InvalidUUID_10 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == genericError.errorMessages.unhandledException
        ...
        @User_Update_noID_11 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == genericError.errorMessages.unhandledException
        ...
        @User_Update_InvalidID_12 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
        ...
        * assert updatedUserprofileResponseBody.Errors[0].message == genericError.errorMessages.unhandledException
        ...
        @User_Update_NameWithMorethanMaxCharacters_13 @coreServicesDontRun @regression @negative @updateProfile @eGovUser
