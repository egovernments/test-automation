...
@Update_NoLogin_Password_InValidOTP_02 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_NoOtpReference_03 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_NoNewPassword_04 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_NoUserName_05 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_NotenantId_06 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_Notype_07 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_InValidUserName_08 @coreServices @negative @userPasswordNoLogin @eGovUser
...
@Update_NoLogin_Password_InValidtenantId_09 @coreServices @negative @userPasswordNoLogin @eGovUser
