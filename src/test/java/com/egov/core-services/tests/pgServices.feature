...
@PGCreate_01  @coreServices @positive  @pgservices
...
@PGCreate_InvalidTxnAmt_03  @coreServices @negative  @pgservices
...
@PGCreate_InvalidTenant_04  @coreServices @negative  @pgservices
...
@PGCreate_InvalidGateway_05  @coreServices @negative  @pgservices
...
@PGCreate_AmtVal_07  @coreServices @negative  @pgservices
...
# need to debug this
@PGCreate_ExpBill_08 @coreServices @negative  @pgservices
...
@PGCreate_AmtValDue_09  @coreServices @negative  @pgservices
...
@PGCreate_InvalidBillID_10  @coreServices @negative  @pgservices
...
@PGCreate_DupicatePay_11  @coreServices @negative  @pgservices
...
@PG_Update_01  @coreServices @positive  @pgservices
...
@PGUpdate_InvalidTxnId_02  @coreServices @negative  @pgservices
...
@PGUpdate_NoTxnId_03  @coreServices @negative  @pgservices
...
@PGUpdate_BillVal_05  @coreServices @negative  @pgservices
...
@PGSearch_Txn_01  @coreServices @negative  @pgservices
...
@PGSearch_InvalidTxn_02  @coreServices @negative  @pgservices
Scenario: Verify searching transaction details using null/ invalid/non existent  value for "transaction id"
  ...
  * call read('../../core-services/pretests/pgServiceSearch.feature@searchPgTransactionSuccessfully')
  ...
  # need to debug this
  @PGSearch_MultipleTxn_03  @coreServices @negative  @pgservices
