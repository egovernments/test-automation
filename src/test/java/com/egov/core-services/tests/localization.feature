...
@SearchLocale_SpecificModule_01 @coreServices @positive @localization
...
@SearchLocale_AllModules_02  @coreServices @positive @localization
...
@SearchLocale_InvalidLocale_03  @coreServices @negative @localization
...
@SearchLocale_noLocale_05  @coreServices @negative @localization
...
@SearchLocale_MultipleData_07 @coreServices @positive @localization
...
@SearchLocale_noModule_08 @coreServices @negative @localization
...
@Upsert_Locale_01 @coreServices @positive @localization
...
@Upsert_MandatoryValidation_02  @coreServices @negative @localization
...
@Upsert_InvaliidTenantId_03 @coreServices @negative @localization
...
@Upsert_CharCount_Code_04  @coreServices @negative @localization
...
@Upsert_CharCount_message_05 @coreServices @negative @localization
...
@Upsert_CharCount_Locale_06 @coreServices @negative @localization
...
@Update_Localisation_01 @coreServices @positive @localization
...
@Update_Localisation_02 @coreServices @negative @localization
...
@Update_Localisation_Null_03 @coreServices @negative @localization
...
@Update_Localisation_Invalid_tenantid_06 @coreServices @negative @localization
Scenario: Test by passing a invalid value for Tenant ID
...
@Update_Search_Localisation_07 @coreServices @positive @localization
Scenario: Test to update existing localisation message
    * def locale = mdmsStatecommonMasters.StateInfo[0].languages[0].value
    * call read('../../core-services/pretests/localizationMessage.feature@searchLocalizationSuccessfully')
    * def index = randomNumber(localizationMessageResponseBody.messages.length)
...
#Create Test cases
@Create_Localisation_01 @coreServices @positive @localization
...
@Create_search_Localisation_02 @coreServices @positive @localization
...
@Create_update_Localisation_03 @coreServices @positive @localization
...
@Create_null_Localisaltion_04 @coreServices @negative @localization
...
@Create_multiple_messages_05 @coreServices @positive @localization
...
@Create_InvaliidTenantId_06 @coreServices @negative @localization
Scenario: Test by passing a invalid value for Tenant ID
    * def tenantId = commonConstants.invalidParameters.emptyValue
    # calling create localization pretest
    * call read('../../core-services/pretests/localizationUpdate.feature@updateLocalizationMessageWithInvalidTenantIdError')  
...
@v2Search_Localisation_01 @coreServices @positive @localization
...
@v2Search_Localisation_multiple_02 @coreServices @positive @localization
...
@v2Search_Localisation_v1Url_03 @coreServices @positive @localization
...
@v2Search_Localisation_Invalid_locale_06  @coreServices @negative @localization
...
@v2Search_Localisation_Invalid_tenantid_07 @coreServices @negative @localization
