...
@Get_MDMS_01 @regression @positive @getMdms @mdmsService
...
@Get_MDMS_MultipleMod_02 @regression @negative @getMdms @mdmsService
...
@Get_MDMS_NoModName_03 @regression @negative @getMdms @mdmsService
...
@Get_MDMS_NoMasterName_04 @regression @negative @getMdms @mdmsService
Scenario: Test to get MDMS details with no module name
...
@Get_MDMS_NoTenantId_05 @regression @negative @getMdms @mdmsService
...
@Get_MDMS_InvalidTenantId_06 @regression @negative @getMdms @mdmsService
...
@Get_MDMS_Invalidparamvalues_07 @regression @negative @getMdms @mdmsService
