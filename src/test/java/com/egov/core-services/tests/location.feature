...
@SearchLocation_01  @coreServices @positive  @location
...
@SearchLocation_NoTenantId_02  @coreServices @negative  @location
...
@SearchLocation_NonExistentValues_03  @coreServices @negative  @location
...
@SearchLocation_MultiplehierarchyTypeCode_04  @coreServices @positive  @location
Scenario: Send a POST request by passing Multiple hierarchyTypeCode and search for the location details for a particular Tenant
      ...
      * match searchLocationResponseBody == '#present'   
@SearchLocation_AllRecords_05  @coreServices @positive  @location
...
@SearchLocation_MulltipleTenantId_08  @coreServices @negative  @location
