...
@IdGen_Generate_01 @coreServices @positive @idGenerate
...
@IdGen_GeneratetMulti_02 @coreServices @positive @idGenerate
...
@IdGen_switchIdName_03 @coreServices @positive @idGenerate
...
@IdGen_invalidTenantId_04 @coreServices @negative @idGenerate
...
@IdGen_BlankFormat_06 @coreServices @negative @idGenerate
...
@IdGen_InvalidSeqFormat_07 @coreServices @negative @idGenerate
