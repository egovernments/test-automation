...
@Update_Password_ValidExistingPassword_validNewPassword_01 @Update_Password_SameAsExistingPassword_10 @coreServices @positive @userPassword @eGovUser
...
@Update_Password_ValidExistingPassword_InvalidNewPassword_02 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_InValidExistingPassword_validNewPassword_03 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_notenantId_04 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_InValidtenantId_05 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_noType_06 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_noExistingPassword_07 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_noNewPassword_08 @coreServices @negative @userPassword @eGovUser
...
@Update_Password_InvalidType_09 @coreServices @negative @userPassword @eGovUser
