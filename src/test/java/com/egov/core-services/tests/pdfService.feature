...
@pdf_create_PT_01  @coreServices @positive  @pdfservice
...
@pdf_create_PT_FS_02  @coreServices @positive  @pdfservice
...
@pdf_create_TL_03  @coreServices @positive  @pdfservice
...
@pdf_create_TL_FS_04  @coreServices @positive  @pdfservice
...
@pdf_create_Fire_05  @coreServices @positive  @pdfservice
...
@pdf_create_Fire_FS_06  @coreServices @positive  @pdfservice
...
@pdf_create_WS_05  @coreServices @positive  @pdfservice
...
@pdf_create_WS_FS_07  @coreServices @positive  @pdfservice
...
@pdf_create_inavlid_tenantid_08  @coreServices @negative  @pdfservice
Scenario: "Verify generating PDF without tenant id and check for errors(all the modules)"
  ...
  * assert pdfCreate == pdfCreateConstant.errorMessages.invalidTenantId
        ...
        @pdf_create_invalid_key_09  @coreServices @negative  @pdfservice
...
@pdf_createnosave_PT_01  @coreServices @positive  @pdfservice
...
@pdf_createnosave_TL_02  @coreServices @positive  @pdfservice
...
@pdf_createnosave_WS_03  @coreServices @positive  @pdfservice
...
@pdf_createnosave_FireNOC_04  @coreServices @positive  @pdfservice
...
@pdf_noqueryparams_FireNOC_05  @coreServices @negative  @pdfservice
...
@pdf_invalidKey_06  @coreServices @negative  @pdfservice
