...
@MetadataGet_01  @coreServices @positive  @reports
...
@MetadataGet_InvalidReportName_02  @coreServices @negative  @reports
...
@MetadataGet_InvalidTenant_03  @coreServices @negative  @reports
...
@Report_Get_01  @coreServices @positive  @reports
...
@Report_InvalidTenant_02  @coreServices @negative  @reports
Scenario: Test by passing invalid/non existent or null value for tenant id
      * def tenantId = invalidTenantId
      # calling get report pretest
...
@Report_InvalidReportName_03  @coreServices @negative  @reports
Scenario: Test by passing invalid/non existent or null value for reportname id
...
@Report_NoSeacrhParama_04  @coreServices @positive  @reports
...
@Report_InvalidSearchParams_05  @coreServices @negative  @reports
