...
@SewerageConnection_UpdateToDOCUMENT_VERIFICATION_01 @positive @regression @swServices @swerageConnectionUpdate
...
@SewerageConnection_SearchWithValidApplicationNumber_01 @positive @regression @swServices @sewerageConnectionSearch
...
@createActiveSewerageConnection
