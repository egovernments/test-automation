...
Background:
    ...
    * match fsmResponseBody.fsm[0].applicationNo == '#present'
    ...
    @fsm_create_InvalidMob_02 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidMobileNo
    ...
    @fsm_create_InvalidProperty_03 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidProperity
    ...
    @fsm_create_InvalidVehicle_04 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidVehicleType
    ...
    @fsm_create_InvalidSource_05 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidSource
    ...
    @fsm_create_InvalidTenant_06 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidTenant
    ...
    @fsm_create_InvalidLocalityCode_07 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidLocalityCode
    ...
    @fsm_create_InvalidnoOfTrips_08 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidNoofTrips
    ...
    @fsm_create_InvalidPitValues_09 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidNoofTrips
    ...
    @fsm_create_InvalidSanitationType_10 @negative @regression @municipalServices @fsmService @fsmServiceCreate
    ...
    * match fsmResponseBody.fsm[0].applicationNo == '#present'
    ...
    @fsm_update_invalid_app_status_02 @negative @regression @municipalServices @fsmService @fsmServiceUpdate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidStatus
    ...
    @fsm_update_invalid_Sanitation_Type_03 @negative @regression @municipalServices @fsmService @fsmServiceUpdate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidSanitationType
    ...
    @fsm_update_invalid_Veh_Type_04 @negative @regression @municipalServices @fsmService @fsmServiceUpdate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidVehicleType
    ...
    @fsm_update_invalid_dso_id_05 @negative @regression @municipalServices @fsmService @fsmServiceUpdate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidDSO
    ...
    @fsm_update_invalid_action_06 @negative @regression @municipalServices @fsmService @fsmServiceUpdate
    ...
    * match fsmResponseBody.fsm[0] == '#present'
    ...
    @fsm_searchInvalidTenant_02 @negative @regression @municipalServices @fsmService @fsmServiceSearch
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @fsm_search_no_tenant_03 @negative @regression @municipalServices @fsmService @fsmServiceSearch
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.noTenanteID
    ...
    @fsm_search_Invalid_Mobile_04 @negative @regression @municipalServices @fsmService @fsmServiceSearch
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidMobileNo
    ...
    @fsm_search_Invalid_App_Status_05 @negative @regression @municipalServices @fsmService @fsmServiceSearch
    ...
    * match fsmResponseBody.fsm[0] == '#notpresent'
    ...
    @fsm_search_Multiple_App_No_06 @negative @regression @municipalServices @fsmService @fsmServiceSearch
    ...
    * match fsmResponseBody.fsm[0] == '#notpresent'
    ...
    @fsm_search_null_dates_07 @negative @regression @municipalServices @fsmService @fsmServiceSearch
    ...
    * match fsmResponseBody.Errors[0].code == fsmConstants.errorMessages.invalidFromDate
    ...
    @audit_01 @positive @regression @municipalServices @fsmService @fsmServiceAudit
    ...
    * match fsmResponseBody.fsm[0] == '#notpresent'
    ...
    @audit_No_Application_02 @negative @regression @municipalServices @fsmService @fsmServiceAudit
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.noApplicationNo
    ...
    @audit_No_Tenant_03 @negative @regression @municipalServices @fsmService @fsmServiceAudit
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.noTenantId
    ...
    @audit_Invalid_TenantID_04 @negative @regression @municipalServices @fsmService @fsmServiceAudit
    Scenario: Verify Audit for a fsm service without passing TenantID
    * call read('../../municipal-services/pretests/fsmServicesPretest.feature@createFsmSuccessfully')
    * def tenantId = randomString(10)
    * def getFsmAuditParam = {"tenantId": '#(tenantId)',"applicationNo": '#(applicationNo)'}
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @audit_Invalid_App_No_05 @negative @regression @municipalServices @fsmService @fsmServiceAudit
    Scenario: Verify Audit for a fsm service without passing TenantID
    ...
    * match fsmResponseBody.fsm[0] == '#notpresent'
    ...
    @vendor_create_01 @positive @regression @municipalServices @fsmService @fsmServiceVendorCreate
    ...
    * match fsmResponseBody.vendor[0] == '#present'
    ...
    @vendor_create_Invalid_Mobile_02 @positive @regression @municipalServices @fsmService @fsmServiceVendorCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.wrongMobileNo
    ...
    @vendor_create_Invalid_Vendor_Tenant_03 @positive @regression @municipalServices @fsmService @fsmServiceVendorCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidLocalityCode
    ...
    @vendor_Search_01 @positive @regression @municipalServices @fsmService @fsmServiceVendorSearch
    Scenario: Verify Vendor Search for a fsm service
    * def getFsmVendorSearchParam = {"tenantId": '#(tenantId)'}
    * call read('../../municipal-services/pretests/fsmServicesPretest.feature@vendorSearchFsmSuccessfully')
    * match fsmResponseBody.vendor[0] == '#present'

    @vendor_Search_No_tenant_02 @negative @regression @municipalServices @fsmService @fsmServiceVendorSearch
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.noTenantId
    ...
    @vendor_Search_Invalid_Mob_03 @negative @regression @municipalServices @fsmService @fsmServiceVendorSearch
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidMobileNo
    ...
    @vehicle_create_01 @positive @regression @municipalServices @fsmService @fsmServiceVehicalCreate
    ...
    * match fsmResponseBody.vehicle[0] == '#present'
    ...
    @vehicle_create_Dup_Reg_02 @negative @regression @municipalServices @fsmService @fsmServiceVehicalCreate
    Scenario: Verify vehical create for a fsm service
    * def getFsmVendorSearchParam = {"tenantId": '#(tenantId)'}
    * call read('../../municipal-services/pretests/fsmServicesPretest.feature@vendorSearchFsmSuccessfully')
    * def getFsmVehicalSearchParam = {"tenantId": '#(tenantId)',"type": '#(vehicalType)'}
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidRegistration
    ...
    @vehicle_create_invalid_type_03 @negative @regression @municipalServices @fsmService @fsmServiceVehicalCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.wrongVehical
    ...
    @vehicle_create_invalid_suction_04 @negative @regression @municipalServices @fsmService @fsmServiceVehicalCreate
    Scenario: Verify vehical create for a fsm service with invalid vehical type
    * def getFsmVendorSearchParam = {"tenantId": '#(tenantId)'}
    * call read('../../municipal-services/pretests/fsmServicesPretest.feature@vendorSearchFsmSuccessfully')
    * def getFsmVehicalSearchParam = {"tenantId": '#(tenantId)',"type": '#(vehicalType)'}
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidSuctionType
    ...
    @vehicle_create_access_05 @negative @regression @municipalServices @fsmService @fsmServiceVehicalCreate
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @vehicle_create_reg_mandatory_06 @negative @regression @municipalServices @fsmService @fsmServiceVehicalCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.withOutRegistration
    ...
    @vehicle_search_01 @positive @regression @municipalServices @fsmService @fsmServiceVehicalSearch
    Scenario: Verify vehical Search for a fsm service
    * def getFsmVehicalSearchParam = {"tenantId": '#(tenantId)',"type": '#(vehicalType)'}
    * call read('../../municipal-services/pretests/fsmServicesPretest.feature@vehicalSearchFsmSuccessfully')
    * match fsmResponseBody.vehicle[0] == '#present'

    @vehicle_search_No_params_02 @negative @regression @municipalServices @fsmService @fsmServiceVehicalSearch
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.noParams
    ...
    @vehicle_search_only_tenant_03 @negative @regression @municipalServices @fsmService @fsmServiceVehicalSearch
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.onlyTenantId
    ...
    @vehicle_search_no_tenant_04 @negative @regression @municipalServices @fsmService @fsmServiceVehicalSearch
    Scenario: Verify vehical Search for a fsm service without tenantID
    * def getFsmVehicalSearchParam = {"type": '#(vehicalType)'}
    * call read('../../municipal-services/pretests/fsmServicesPretest.feature@vehicalSearchFsmError')
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.noTenantId

    @vehicle_search_Invalid_reg_05 @negative @regression @municipalServices @fsmService @fsmServiceVehicalSearch
    ...
    * match fsmResponseBody.vehicle[0] == '#notpresent'
    ...
    @vehicle_search_Invalid_tenant_06 @negative @regression @municipalServices @fsmService @fsmServiceVehicalSearch
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @trip_search_01 @positive @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#present'
    ...
    @trip_search_No_Access_02 @positive @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @trip_search_Invalid_Veh_id_03 @negative @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#notpresent'
    ...
    @trip_search_Invalid_businessService_04 @negative @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#notpresent'
    ...
    @trip_search_Invalid_refno_05 @negative @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#notpresent'
    ...
    @trip_search_Invalid_app_no_06 @negative @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#notpresent'
    ...
    @trip_search_Invalid_SortBy_07 @negative @regression @municipalServices @fsmService @fsmServiceTripSearch
    ...
    * match fsmResponseBody.Errors[0].code == fsmConstants.errorMessages.invalidSort
    ...
    @trip_search_Invalid_SortOrder_08 @negative @regression @municipalServices @fsmService @fsmServiceTripSearch
    Scenario: Verify vehical Trip Search for a fsm service with invalid Sort Order
    ...
    * match fsmResponseBody.Errors[0].code == fsmConstants.errorMessages.invalidSortedOrder
    ...
    @trip_Create_01 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#present'
    ...
    @trip_Create_Invalid_Veh_02 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidVehicalId+vehicalId
    ...
    @Trip_Create_No_Access_03 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @trip_Create_Veh_Id_04 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.withoutVehicalId
    ...
    @trip_Create_Invalid_Tank_05 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidNoofTrips
    ...
    @trip_Create_No_Ref_06 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidTankCapacity
    ...
    @trip_Create_No_Ref_status_07 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripCreate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidRefStatus
    ...
    @trip_Update_01 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripUpdate
    ...
    * match fsmResponseBody.vehicleTrip[0] == '#present'
    ...
    @trip_Update_No_Access_02 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripUpdate
    ...
    * match fsmResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @trip_Update_Invalid_VehicleId_03 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripUpdate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidVehicalId+fsmResponseBody.vehicleTrip[0].id
    @trip_Update_Veh_Trip_Err_04 @positive @regression @municipalServices @fsmService @fsmServiceVehicalTripUpdate
    ...
    * match fsmResponseBody.Errors[0].message == fsmConstants.errorMessages.invalidTripId
    ...
    @fsm_search_location_01 @positive @regression @municipalServices @fsmService @fsmServiceSearch
    Scenario: Verify searching for a fsm service
    * def getFsmSearchParam = {"tenantId": '#(tenantId)'}
    ...
    * match fsmResponseBody.TenantBoundary[0] == '#present'
    ...
    @fsm_create_NoSLum_01 @positive @regression @municipalServices @fsmService @fsmServiceCreate
