...
Background:
    ...
    * def plotSize = 123
    ...
    @fireNoc_Create_01 @positive @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.ResponseInfo.status == fireNocConstants.status.status
    ...
    @fireNoc_Create_Invalid_noBuildings_02 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidBuildType
    ...
    @fireNoc_Create_nvalid_UsageType_03 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidUsageType
    ...
    @fireNoc_Create_Invalid_uom_04 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidUomCode
    ...
    @fireNoc_Create_Invalid_active_05 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidUomActive
    ...
    @fireNoc_Create_Invalid_mob_06 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    Scenario: Verify creating a fire noc service application through API with invalid active
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidMobileNumber
    ...
    @fireNoc_Create_null_values_07 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[1].message == fireNocConstants.errorMessages.invalidBuildType
    ...
    @fireNoc_Create_action_error_08 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    Scenario: Verify creating a fire noc service application through API with invalid action type
    * def action = randomString(8)
    * call read('../../municipal-services/pretests/fireNocPretest.feature@createFireNocError1')
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidBuildType

    @fireNoc_Create_Invalid_tenant_09 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @fireNoc_Create_invalid_FirestnID_10 @negative @regression @municipalServices @fireNocService @fireNocServiceCreate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidFirestation
    ...
    @search_01 @positive @regression @municipalServices @fireNocService @fireNocServiceSearch
    ...
    * match fireNocResponseBody.FireNOCs[0] == '#present'
    ...
    @search_AllRecords_02 @positive @regression @municipalServices @fireNocService @fireNocServiceSearch
    ...
    * match fireNocResponseBody.FireNOCs[0] == '#present'
    ...
    @search_InvalidTenant_03 @negative @regression @municipalServices @fireNocService @fireNocServiceSearch
    ...
    * match fireNocResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @Search_empty_04 @positive @regression @municipalServices @fireNocService @fireNocServiceSearch
    ...
    * match fireNocResponseBody.FireNOCs[0] == '#notpresent'
    ...
    @search_InvalidMob_05 @negative @regression @municipalServices @fireNocService @fireNocServiceSearch
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidMObileNo
    ...
    @updateNoc_01 @positive  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.FireNOCs[0].tenantId == tenantId
    ...
    @update_Invalid_noBuildings_02 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.billingSlabError
    ...
    @update_Invalid_UsageType_03 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidUsageType
    ...
    @update_Invalid_uom_04 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidUomCode
    ...
    @update_Invalid_active_05 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidUomActive
    ...
    @update_Invalid_mob_06 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidMobileNumber
    ...
    @update_null_values_07 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[1].message == fireNocConstants.errorMessages.invalidBuildType
    ...
    @update_action_error_08 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidAction + ': ' + applicationNo
    ...
    @update_Invalid_tenant_09 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    ...
    * match fireNocResponseBody.Errors[0].message == commonConstants.errorMessages.authorizedError
    ...
    @update_Invalid_action_10 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    Scenario: Update FireNoc service with invalid action
    * call read('../../municipal-services/pretests/fireNocPretest.feature@createFireNocSuccessfully')
    # Initializing search query params
    ...
    * match fireNocResponseBody.Errors[0].message == fireNocConstants.errorMessages.invalidBuildType
    ...
    @update_invalid_FirestnID_11 @negative  @regression @municipalServices @fireNocService @fireNocServiceUpdate
    Scenario: Update FireNoc service with invalid action
    * call read('../../municipal-services/pretests/fireNocPretest.feature@createFireNocSuccessfully')
    # Initializing search query params
