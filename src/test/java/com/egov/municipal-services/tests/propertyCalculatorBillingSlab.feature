...
@BillingSlab_Create_01 @billingSlabCreate @regression @municipalServices @propertyCalculator @positive
Scenario: Verify creating a billing slab for property tax through API call
 ...
 @BillingSlab_Create_InValidTenant_02 @billingSlabCreate @regression @municipalServices @propertyCalculator @negative
...
@BillingSlab_Create_Dup_03 @billingSlabCreate @regression @municipalServices @propertyCalculator @negative
Scenario: Verify creating a billing slab for property tax through API call
    #Steps to create billing slab
    * call read('../../municipal-services/pretests/propertyCalculatorServicesPretest.feature@createBillingSlab')
...
@BillingSlab_Create_nullValues_04 @billingSlabCreate @regression @municipalServices @propertyCalculator @negative
...
@Billing_slab_create_invalidValues_05 @billingSlabCreate @regression @municipalServices @propertyCalculator @negative
Scenario: Verify creating a billing slab for property tax by passing null values in the request
...
@BillingSlab_Search_01 @billingSlabSearch @regression @municipalServices @propertyCalculator @positive
...
@BillingSlab_Search_AllRecords_02 @billingSlabSearch @regression @municipalServices @propertyCalculator @positive
...
@BillingSlab_Search_NoTenant_03 @billingSlabSearch @regression @municipalServices @propertyCalculator @positive
...
@BillingSlab_Search_InValidTenant_04 @billingSlabSearch @regression @municipalServices @propertyCalculator @positive
...
@BillingSlab_Search_EmptyResponse_05 @billingSlabSearch @regression @municipalServices @propertyCalculator @negative
...
@BillingSlab_Search_Multiple_06 @billingSlabSearch @regression @municipalServices @propertyCalculator @positive
...
@BillingSlab_update_01 @billingSlabUpdate @regression @municipalServices @propertyCalculator @positive
...
@BillingSlab_update_InValidTenant_02 @billingSlabUpdate @regression @municipalServices @propertyCalculator @negative
...
@BillingSlab_update_InvalidId_03 @billingSlabUpdate @regression @municipalServices @propertyCalculator @negative
...
@BillingSlab_update_nullValues_04 @billingSlabUpdate @regression @municipalServices @propertyCalculator @negative
...
@Billing_slab_update_invalidValues_05 @billingSlabUpdate @regression @municipalServices @propertyCalculator @negative
Scenario: Verify updating a billing slab for property tax by passing null values in the request
    # Steps to create billing slab
    * call read('../../municipal-services/pretests/propertyCalculatorServicesPretest.feature@createBillingSlab')
