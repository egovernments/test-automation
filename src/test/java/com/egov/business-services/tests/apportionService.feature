...
# Next suite of automation code will have automated port forward configuration.
   @apportion_bill_01 @regression @positive @apportionService @ignore
   ...
   @apportion_billWithAdjustedAmount_02 @regression @positive @apportionService @ignore
   ...
   @apportion_bill_InvalidBusinessService_03 @regression @negative @apportionService @ignore
   ...
   @apportion_bill_amountPaidNULL_04 @regression @negative @apportionService @ignore
   ...
   @apportion_bill_IsAdvanceAllowedNULL_05 @regression @negative @apportionService @ignore
   Scenario: Test to apportion a bill with isAdvanceAllowed as a NULL
     * def isAdvanceAllowed = {}
     * call read('../../business-services/pretests/apportionServicePretest.feature@errorApportion')
     * match apportionResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

   @apportion_bill_WithOneTaxHeadCode_06 @regression @positive @apportionService @ignore
   ...
   @apportion_bill_WithNoBillAccountDetails_07 @regression @negative @apportionService @ignore
   ...
   @apportion_bill_WithexpiryDateNull_08 @regression @negative @apportionService @ignore
   Scenario: Test to apportion a bill with Expiry date as NULL
     * def expiryDate = {}
     * call read('../../business-services/pretests/apportionServicePretest.feature@errorApportion')
     * match apportionResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

   @apportion_bill_NULLtaxHeadCode_09 @regression @negative @apportionService @ignore
   ...
   @apportion_bill_NoTenantId_10 @regression @negative @apportionService @ignore
   Scenario: Test to apportion a bill with No tenantId
     * def tenantId = {}
     * call read('../../business-services/pretests/apportionServicePretest.feature@errorApportion')
     * match apportionResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

   @apportion_bill_InValidTenantId_11 @regression @negative @apportionService @ignore
   ...
   @apportion_bill_PartialAmount_12 @regression @positive @apportionService @ignore
   ...
   @apportion_bill_FullAmount_13 @regression @positive @apportionService @ignore
   ...
   @apportion_bill_AdvancePayment_14 @regression @positive @apportionService @ignore
   ...
   @apportion_bill_VerifyOrder_15 @regression @positive @apportionService @ignore
