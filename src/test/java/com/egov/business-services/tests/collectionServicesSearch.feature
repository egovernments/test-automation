...
@Search_PaymentWithReceiptNumber_01 @businessServices @regression @positive @SearchPayment @collectionServices
...
@Search_PaymentWithBillID_02 @businessServices @regression @positive @SearchPayment @collectionServices
...
@Search_PaymentWithConsumerCode_03 @businessServices @regression @positive @SearchPayment @collectionServices
...
@Search_PaymentWithMobileNumber_04 @businessServices @regression @positive @SearchPayment @collectionServices
...
@Search_PaymentWithMobileNumberAndReceiptNumber_05 @businessServices @regression @positive @SearchPayment @collectionServices
...
@Search_AllPayments_06 @businessServices @regression @positive @SearchPayment @collectionServices
...
@Search_PaymentWith_InvalidtenatID_07 @businessServices @regression @negative @SearchPayment @collectionServices
...
@Search_PaymentWith_InvalidMobileNumber_08 @businessServices @regression @negative @SearchPayment @collectionServices
...
@Search_PaymentWith_InvalidReceiptNumber_09 @businessServices @regression @negative @SearchPayment @collectionServices
