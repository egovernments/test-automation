...
@ChartOfAccountCreate_01 @chartOfAccountCreate
...
@ChartOfAccountCreate_UniqueBank_02  @chartOfAccountCreate
...
@ChartOfAccountCreate_InValidTEnant_03  @chartOfAccountCreate
...
@ChartOfAccountCreate_GcodeLen_04  @chartOfAccountCreate
...
@ChartOfAccountCreate_nameLen_05  @chartOfAccountCreate
...
@ChartOfAccountCreate_InvalidType_06  @chartOfAccountCreate
...
@ChartOfAccountCreate_UniqueGlcode_07  @chartOfAccountCreate
...
@ChartOfAccountCreate_08  @chartOfAccountCreate
...
@ChartOfAccountCreate_nullvalues_09  @chartOfAccountCreate
...
@ChartOfAccountSearch_01  @chartOfAccountSearch
...
@ChartOfAccountSearch_InvalidTenant_02  @chartOfAccountSearch
Scenario: Verify with a invalid or non existant tenant id and check for errors
* def tenantId = invalidTenantId
...
@ChartOfAccountSearch_TenantIdMandatory_06  @chartOfAccountSearch
