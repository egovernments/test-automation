...
@BankAccountCreate_01  @positive @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression @businessServicesDontRun
...
@BankAccountCreate_UniqueAccNum_03 @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression @businessServicesDontRun
...
@BankAccountCreate_InValidActive_04  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression @businessServicesDontRun
...
@BankAccountCreate_InValidType_05  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression @businessServicesDontRun
...
@BankAccountCreate_InvalidLenNum_07  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression @businessServicesDontRun
...
@BankAccountCreate_InvalidLenDesc_08  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression @businessServicesDontRun
...
@BankAccountCreate_InvalidLenPayTo_09  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster@regression @businessServicesDontRun
