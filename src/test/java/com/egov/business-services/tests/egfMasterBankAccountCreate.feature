...
@BankAccountCreate_01  @positive @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountCreate_UniqueAccNum_03 @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountCreate_InValidActive_04  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountCreate_InValidType_05  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountCreate_InvalidLenNum_07  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountCreate_InvalidLenDesc_08  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountCreate_InvalidLenPayTo_09  @negative  @bankAccountCreate  @egfMasterBankAccount @egfMaster@regression
