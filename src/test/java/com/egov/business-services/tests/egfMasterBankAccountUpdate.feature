...
@BankAccountUpdate_01  @positive  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
...
@BankAccountUpdate_InValidActive_03  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
...
@BankAccountUpdate_InValidType_04  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
...
@BankAccountUpdate_InvalidLenNum_05  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
...
@BankAccountUpdate_InvalidLenDesc_06  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
...
@BankAccountUpdate_InvalidLenPayTo_07  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
...
@BankAccountUpdate_UniqueAccNum_08  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster
