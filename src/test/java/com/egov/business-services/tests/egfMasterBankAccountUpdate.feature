...
@BankAccountUpdate_01  @positive  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountUpdate_InValidActive_03  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountUpdate_InValidType_04  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountUpdate_InvalidLenNum_05  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountUpdate_InvalidLenDesc_06  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountUpdate_InvalidLenPayTo_07  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
...
@BankAccountUpdate_UniqueAccNum_08  @negative  @bankAccountUpdate  @egfMasterBankAccount @egfMaster @regression
