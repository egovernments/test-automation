...
@BankAccountUpdate_InvalidLenNum_05  @negative  @bankAccountUpdate  @egfMasterBankAccount
...
@BankAccountUpdate_InvalidLenDesc_06  @negative  @bankAccountUpdate  @egfMasterBankAccount
...
@BankAccountUpdate_InvalidLenPayTo_07  @negative  @bankAccountUpdate  @egfMasterBankAccount
...
@BankAccountUpdate_UniqueAccNum_08  @negative  @bankAccountUpdate  @egfMasterBankAccount
