...
@ChartOfAccountUpdate_01  @chartOfAccountUpdate  @chartOfAccount  @positive @egfMaster @businessServices 
...
@ChartOfAccountUpdate_glcodeLen_02  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountUpdate_nameLen_03  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountUpdate_InvalTyp_04  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountUpdate_UniqueGlcode_06  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountUpdate_nullValues_07  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountUpdate_Invaltenant_08  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountUpdate_09  @chartOfAccountUpdate  @chartOfAccount  @positive @egfMaster @businessServices
