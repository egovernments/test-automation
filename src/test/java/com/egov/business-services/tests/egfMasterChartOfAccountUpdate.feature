...
@ChartOfAccountUpdate_01  @chartOfAccountUpdate  @chartOfAccount  @positive @egfMaster @regression 
...
@ChartOfAccountUpdate_glcodeLen_02  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountUpdate_nameLen_03  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountUpdate_InvalTyp_04  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountUpdate_UniqueGlcode_06  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountUpdate_nullValues_07  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountUpdate_Invaltenant_08  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountUpdate_09  @chartOfAccountUpdate  @chartOfAccount  @positive @egfMaster @regression
