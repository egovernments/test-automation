...
@ChartOfAccountUpdate_01  @chartOfAccountUpdate  @chartOfAccount  @positive @egfMaster @businessServices @regression 
Scenario: Verify updating chart of accounts through API call
# Update the existing glcode with new glcode
* def glcode = glcode
* call read('../../business-services/pretest/egfMasterPreTest.feature@updateAccountSuccessfully')
* match chartOfAccountUpdateResponseBody.chartOfAccounts.length == '##[_ > 0]'

@ChartOfAccountUpdate_glcodeLen_02  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices @regression
...
* def glcode = ""
* call read('../../business-services/pretest/egfMasterPreTest.feature@errorInUpdateAccount')
* assert chartOfAccountUpdateResponseBody.errors[0].message == egfMasterChartOfAccountConstant.errorMessages.forInvalidglcode

@ChartOfAccountUpdate_nameLen_03  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices @regression
...
@ChartOfAccountUpdate_InvalTyp_04  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices @regression
...
@ChartOfAccountUpdate_UniqueGlcode_06  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices @regression
...
@ChartOfAccountUpdate_nullValues_07  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices @regression
...
@ChartOfAccountUpdate_Invaltenant_08  @chartOfAccountUpdate  @chartOfAccount  @negative @egfMaster @businessServices @regression
...
@ChartOfAccountUpdate_09  @chartOfAccountUpdate  @chartOfAccount  @positive @egfMaster @businessServices @regression
