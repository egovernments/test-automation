...
@Bank_Search_01 @positive @bankSearch @egfMaster @businessServices
...
@Bank_Search_InvalidTenant_02 @negative @bankSearch @egfMaster @businessServices
...
@Bank_Search_TenantIdMandatory_03 @negative @bankSearch @egfMaster @businessServices
...
@Bank_Search_AllRecords_04 @positive @bankSearch @egfMaster @businessServices
...
@Bank_Search_empty_05 @positive @bankSearch @egfMaster @businessServices
...
@Bank Search_multiple_06 @positive @bankSearch @egfMaster @businessServices
    Scenario: Verify search by passing different combinations of the search params
        # Steps to craete a new Bank 
        * call read('../../business-services/pretest/egfMasterPreTest.feature@createBank')
