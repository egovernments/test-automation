...
@BankBranches_Create_01 @positive @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_NulValues_02 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_UniqueCode_03 @BankBranches_Create_UniqueName_04 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_NullActive_05 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_Active_06 @positive @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_TenantMandatory_07 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_InvalidTenant_08 @BankBranches_Create_Tenant_10 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_Validation_09 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Create_InvalidName_11 @negative @bankBranchCreate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_01 @positive @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_UniqueName_02 @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_UniqueCode_03 @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_InvalidTenant_04 @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_activeNull_05 @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_Validations_06  @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_NameInvalid_07 @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
...
@BankBranches_Update_NulValues_08 @negative @bankBranchUpdate @egfMasterBankBranches @egfMaster @businessServices
    Scenario: Verify updating bank branch passing invalid characters for branch name
        # Creating Bank Branch before Updating it
        * call read('../../business-services/pretest/egfMasterPreTest.feature@createBankBranch')
        # setting request body values
...
@Bank_Branch_Search_01 @positive @bankBranchSearch @egfMasterBankBranches @egfMaster @businessServices
...
@Bank_Branch_Search_InvalidTenant_02 @negative @bankBranchSearch @egfMasterBankBranches @egfMaster @businessServices
...
@Bank_Branch_Search_TenantIdMandatory_03 @negative @bankBranchSearch @egfMasterBankBranches @egfMaster @businessServices
...
@Bank_Branch_Search_AllRecords_04 @positive @bankBranchSearch @egfMasterBankBranches @egfMaster @businessServices
...
@Bank_Branch_Search_empty_05 @positive @bankBranchSearch @egfMasterBankBranches @egfMaster @businessServices
...
@Bank_Branch_Search_combination_06 @positive @bankBranchSearch @egfMasterBankBranches @egfMaster @businessServices
    Scenario: Verify searching bank branch by passing invalid params
        # Creating a new Bank Branch
        * call read('../../business-services/pretest/egfMasterPreTest.feature@createBankBranch')
        # Defining search parameters
