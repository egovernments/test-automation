Feature: Business Services - Billing Service Demand tests
    ...
    * def minimumAmountPayable = 1
    ...
    @create_01 @businessServices @positive @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands[0].status == billingServiceDemandConstants.parameters.status
    ...
    @create_DuplicateConsumerCode_02 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.duplicateConsumerCode + '[' + consumerCode + ']'
    ...
    @create_NoConsumerCode_03 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_NoConsumerType_04 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_InvalidBusinessService_05 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidBusinessService + '[' + businessService + ']'
    ...
    @create_ConsumerCodeWith251Characters_06 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.unhandledException
    ...
    @create_NoBusinessService_07 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_InvalidTaxPeriodFrom_08 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.jsonDeserializeError
    ...
    @create_ZeroTaxPeriod_09 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.zeroTaxPeriodError
    ...
    @create_NULLTaxPeriod_10 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_InvalidTaxHeadMasterCode_11 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTaxHeadMasterCode + '[' + taxHeadMasterCode + ']'
    ...
    @create_NoTaxHeadMasterCode_12 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_MorethanMaxTaxAmount_13 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.unhandledException
    ...
    @create_NoTaxAmount_14 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_collectionAmountMorethanTaxAmount_15 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message contains billingServiceDemandConstants.expectedMessages.collectionAmountMoreThanTaxAmount
    ...
    @create_NocollectionAmount_16 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_MorethanMax_MinimumAmountPayable_17 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.unhandledException
    ...
    @create_InvalidTenantId_18 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTenantId || billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.invalidTenantIdError
    ...
    @create_NoTenantId_19 @businessServices @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @search_01 @search_WithDemandId_09 @businessServices @positive @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands[0].demandDetails[0].taxAmount == taxAmount
    ...
    @search_InvalidConsumerCode_02 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands == '#[0]'
    ...
    @search_InvalidBusinessService_03 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands == '#[0]'
    ...
    @search_NoConsumerCode_04 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands != '#[0]'
    ...
    @search_NoBusinessService_05 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands != '#[0]'
    ...
    @search_InvalidTenantId_06 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.invalidTenantIdError
    ...
    @search_NoTenantId_07 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @search_WithOnlyTenantId_08 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.onlyTenantId
    ...
    @search_InvalidDemandId_10 @businessServices @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands == '#[0]'
    ...
    @update_01 @businessServices @positive @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands[0].status == billingServiceDemandConstants.parameters.status
    ...
    @update_InvalidDemandId_02 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.demandNotFound + '[' + invalidDemandId + ']'
    ...
    @update_NoDemandId_03 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.demandIdMandatory
    ...
    @update_InvalidBusinessService_04 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidBusinessService + '[' + invalidBusinessService + ']'
    ...
    @update_NoBusinessService_05  @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_InvalidTaxPeriods_06 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.zeroTaxPeriodError
    ...
    @update_NoTaxPeriods_07 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_InvalidTaxheadMasterCode_08 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTaxHeadMasterCode + '[' + invalidTaxHeadMasterCode + ']'
    ...
    @update_NoTaxAmount_09 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_InvalidtenantId_10 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTenantId || billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.invalidTenantIdError
    ...
    @update_NotenantId_11 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_CollectionAmountGreaterThanTaxAmount_12 @businessServices @negative @billingServiceDemandUpdate @billingServiceDemand
