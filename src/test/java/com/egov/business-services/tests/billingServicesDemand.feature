Feature: Business Services - Billing Service Demand tests
    ...
    * def minimumAmountPayable = 1
    ...
    @create_01 @businessServices @regression @positive @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands[0].status == billingServiceDemandConstants.parameters.status
    ...
    @create_DuplicateConsumerCode_02 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.duplicateConsumerCode + '[' + consumerCode + ']'
    ...
    @create_NoConsumerCode_03 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@errorCreateRemoveField') {'removeFieldPath': '$.Demands[0].consumerCode'}
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_NoConsumerType_04 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@errorCreateRemoveField') {'removeFieldPath': '$.Demands[0].consumerType'}
    # Validate that actual error returned by API for no consumer type field is same as expected error message
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

    @create_InvalidBusinessService_05 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidBusinessService + '[' + businessService + ']'
    ...
    @create_ConsumerCodeWith251Characters_06 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.unhandledException
    ...
    @create_NoBusinessService_07 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@errorCreateRemoveField') {'removeFieldPath': '$.Demands[0].businessService'}    
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

    @create_InvalidTaxPeriodFrom_08 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.jsonDeserializeError
    ...
    @create_ZeroTaxPeriod_09 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.zeroTaxPeriodError
    ...
    @create_NULLTaxPeriod_10 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_InvalidTaxHeadMasterCode_11 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTaxHeadMasterCode + '[' + taxHeadMasterCode + ']'
    ...
    @create_NoTaxHeadMasterCode_12 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    Scenario: Test to Create Demand with no tax head master code
    # Steps to create a employee without taxHeadMasterCode
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@errorCreateRemoveField') {'removeFieldPath': '$.Demands[0].demandDetails[0].taxHeadMasterCode'}
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

    @create_MorethanMaxTaxAmount_13 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.unhandledException
    ...
    @create_NoTaxAmount_14 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    Scenario: Test to Create Demand with no tax amount
    # Steps to create a employee without taxAmount field in request
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@errorCreateRemoveField') {'removeFieldPath': '$.Demands[0].demandDetails[0].taxAmount'}
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

    @create_collectionAmountMorethanTaxAmount_15 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message contains billingServiceDemandConstants.expectedMessages.collectionAmountMoreThanTaxAmount
    ...
    @create_NocollectionAmount_16 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @create_MorethanMax_MinimumAmountPayable_17 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.unhandledException
    ...
    @create_InvalidTenantId_18 @businessServices @regression @negative @billingServiceDemandCreate @billingServiceDemand
    ...
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@errorCreateRemoveField') {'removeFieldPath': '$.Demands[0].tenantId'}
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError

    @search_01 @search_WithDemandId_09 @businessServices @regression @positive @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands[0].demandDetails[0].taxAmount == taxAmount
    ...
    @search_InvalidConsumerCode_02 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands == '#[0]'
    ...
    @search_InvalidBusinessService_03 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands == '#[0]'
    ...
    @search_NoConsumerCode_04 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands != '#[0]'
    ...
    @search_NoBusinessService_05 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands != '#[0]'
    ...
    @search_InvalidTenantId_06 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.invalidTenantIdError
    ...
    @search_NoTenantId_07 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @search_WithOnlyTenantId_08 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * assert billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.onlyTenantId
    ...
    @search_InvalidDemandId_10 @businessServices @regression @negative @billingServiceDemandSearch @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Demands == '#[0]'
    ...
    @update_01 @businessServices @regression @positive @billingServiceDemandUpdate @billingServiceDemand
    ...
    * call read('../../business-services/pretest/billingServiceDemandPretest.feature@updateDemand')
    ...
    * match billingServiceDemandResponseBody.Demands[0].status == billingServiceDemandConstants.parameters.status
    ...
    @update_InvalidDemandId_02 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.demandNotFound + '[' + invalidDemandId + ']'
    ...
    @update_NoDemandId_03 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.demandIdMandatory
    ...
    @update_InvalidBusinessService_04 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidBusinessService + '[' + invalidBusinessService + ']'
    ...
    @update_NoBusinessService_05  @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_InvalidTaxPeriods_06 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.zeroTaxPeriodError
    ...
    @update_NoTaxPeriods_07 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_InvalidTaxheadMasterCode_08 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTaxHeadMasterCode + '[' + invalidTaxHeadMasterCode + ']'
    ...
    @update_NoTaxAmount_09 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_InvalidtenantId_10 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
    ...
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.nullParameterError
    ...
    @update_CollectionAmountGreaterThanTaxAmount_12 @businessServices @regression @negative @billingServiceDemandUpdate @billingServiceDemand
