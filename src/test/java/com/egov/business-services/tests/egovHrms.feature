Feature: Business Services - HRMS
    ...
    * call read('../../business-services/pretest/egovHrmsPretest.feature@searchEmployeeSuccessfullyWithoutEmployeeCodes')
        ...
        @HRMS_create_emp01 @businessServices @positive @hrms_create @hrms @smoke @businessService
    ...
    * assert hrmsResponseBody.Employees[0].user.mobileNumber == mobileNumber
        @HRMS_create_InvalidEMpStatus_02 @businessServices @negative @hrms_create @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.userCreationFailed 
        ...
        @HRMS_create_InvalidDOB_04 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.failedToDeserializeJson
        ...
        @HRMS_create_InvalidGender_05 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.userCreationFailed
        ...
        @HRMS_create_NoFatherName_06 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.notNull
        ...
        @HRMS_create_ExistingMobile_07 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.userAlreadyExists
        ...
        @HRMS_create_NoMobile_08 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.notNull
        ...
        @HRMS_create_InvalidMobileNumber_09 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.invalidMobileNumber
        ...
        @HRMS_create_NoEMpStatus_10 @businessServices @negative @hrms_create @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.notNull
        ...
        @HRMS_create_NoUser_11 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.notNull
        ...
        @HRMS_create_Notenantid_12 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.notNull
        ...
        @HRMS_create_InvalidTenantId_13 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.unauthorized
        ...
        @HRMS_create_InvalidFromDate_14 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.notNull
        ...
        @HRMS_create_DateValidation_15 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert errorMessage == hrmsConstants.expectedMessages.invalidAssignmentPeriod || errorMessage == hrmsConstants.expectedMessages.toDateShouldBeBlank
        ...
        @HRMS_create_InvalidEMpStatus_16 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.invalidEmployeeType
        ...
        @HRMS_create_InvalidJudistrictions_17 @businessServices @negative @hrmsCreate @hrms
    ...
    * assert hrmsResponseBody.Errors[2].message == hrmsConstants.expectedMessages.invalidJurisdictionBoundary
        ...
        @HRMS_create_HierarchySize_18 @businessServices @negative @hrms_create @hrms
    ...
    * assert hrmsResponseBody.Errors[2].message == hrmsConstants.expectedMessages.invalidJurisdictionBoundary
        ...
        @HRMS_InvalidCheck_19 @businessServices @negative @hrms_create @hrms
    ...
    * assert hrmsResponseBody.Errors[1].message == hrmsConstants.expectedMessages.invalidDesignation
        ...
        @HRMS_create_DateValidation1_20 @businessServices @negative @hrms_create @hrms
    ...
    * assert hrmsResponseBody.Errors[1].message == hrmsConstants.expectedMessages.onlyOneCurrentAssigment
        ...
        @HRMS_Search_Emp_01 @businessServices @positive @hrmsSearch @hrms @smoke
    ...
    * call read('../../business-services/pretest/egovHrmsPretest.feature@searchEmployeeSuccessfully')
        ...
        @HRMS_Search_AllEmp_02 @businessServices @positive @hrmsSearch @hrms
    ...
    * assert hrmsResponseBody.ResponseInfo.status == commonConstants.expectedStatus.success
        ...
        @HRMS_Search_Name_05 @businessServices @negative @hrmsSearch @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.tenantIdMandatory
        ...
        @hrmsSearch_InvalidTenantId_06 @businessServices @negative @hrmsSearch @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.unauthorized
        ...
        @HRMS_Search_Multiple_07 @businessServices @positive @hrmsSearch @hrms
    ...
    * assert hrmsResponseBody.Employees[1].code == employeeCode2
        ...
        @HRMS_Update_01 @businessServices @positive @businessServices @positive @hrmsupdate @hrms
    ...
    * assert hrmsResponseBody.Employees[0].user.fatherOrHusbandName == fatherOrHusbandName + "Updated"
        ...
        @HRMS_update_InvalidValidations_02 @businessServices @negative @hrmsupdate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.ERR_HRMS_INVALID_DESG
        ...
        @HRMS_update_DateValDOB_03 @businessServices @negative @hrmsupdate @hrms
    ...
    * assert hrmsResponseBody.Errors[1].message == hrmsConstants.expectedMessages.ERR_HRMS_INVALID_ASSIGNMENT_DATES
        ...
        @HRMS_update_DateValCurAssign_04 @businessServices @negative @hrmsupdate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.unauthorized
        ...
        @HRMS_update_DateValCurSer_06 @businessServices @negative @hrmsupdate @hrms
    ...
    * assert hrmsResponseBody.Errors[0].message == hrmsConstants.expectedMessages.ERR_HRMS_INVALID_ASSIGNMENT_CURRENT_TO_DATE
        ...
        @HRMS_update_AdhaarVal_07 @businessServices @negative @hrmsupdate @hrms
