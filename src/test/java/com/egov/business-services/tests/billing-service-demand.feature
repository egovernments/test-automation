...
Scenario: Test to Search Demand with valid parameter values
    ...
    * call read('../preTests/billingServiceDemandPretest.feature@searchDemand')
    * print billingServiceDemandResponseBody
...
Scenario: Test to Search Demand with invalid consumer code
    ...
    * print billingServiceDemandResponseBody
    * def demandId = billingServiceDemandResponseBody.Demands[0].id
    * def consumerCode = billingServiceDemandConstants.invalidParameters.consumerCode
    * call read('../preTests/billingServiceDemandPretest.feature@searchDemand')
    * print billingServiceDemandResponseBody
    * assert billingServiceDemandResponseBody.ResponseInfo.status == commonConstants.expectedStatus.ok
    * assert searchDemandResponseStatus == 200
...
Scenario: Test to Search Demand with no consumer code
    ...
    * def searchDemandParams =
    ...
    """
    * call read('../preTests/billingServiceDemandPretest.feature@searchDemandGenericParam')
    * print billingServiceDemandResponseBody
    * assert billingServiceDemandResponseBody.ResponseInfo.status == commonConstants.expectedStatus.ok
    * assert searchDemandResponseStatus == 200
    * match billingServiceDemandResponseBody.Demands != '#[0]'
...
Scenario: Test to Search Demand with invalid demand id
    ...
    * print billingServiceDemandResponseBody
    * def demandId = billingServiceDemandResponseBody.Demands[0].id
    * def demandId = billingServiceDemandConstants.invalidParameters.demandId
    * call read('../preTests/billingServiceDemandPretest.feature@searchDemand')
    * print billingServiceDemandResponseBody
    * assert billingServiceDemandResponseBody.ResponseInfo.status == commonConstants.expectedStatus.ok
    * assert searchDemandResponseStatus == 200
...
Scenario: Test to Update Demand with valid field values
    * call read('../preTests/billingServiceDemandPretest.feature@successCreate')
    * print billingServiceDemandResponseBody
    * call read('../preTests/billingServiceDemandPretest.feature@successUpdate')
    * print billingServiceDemandResponseBody
    * assert billingServiceDemandResponseBody.ResponseInfo.status == commonConstants.expectedStatus.created
    * match billingServiceDemandResponseBody.Demands[0].id == "#present"
    * match billingServiceDemandResponseBody.Demands[0].tenantId == tenantId
...
Scenario: Test to Update Demand with invalid demand id
    * call read('../preTests/billingServiceDemandPretest.feature@successCreate')
    * print billingServiceDemandResponseBody
    * eval Demands[0].id = billingServiceDemandConstants.invalidParameters.demandId
    * eval Demands[0].demandDetails[0].id = billingServiceDemandConstants.invalidParameters.demandId
    * call read('../preTests/billingServiceDemandPretest.feature@errorUpdate')
    * print billingServiceDemandResponseBody
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.demandNotFound + '[' + billingServiceDemandConstants.invalidParameters.demandId + ']'
...
Scenario: Test to Update Demand with invalid business service
    * call read('../preTests/billingServiceDemandPretest.feature@successCreate')
    * print billingServiceDemandResponseBody
    * eval Demands[0].businessService = billingServiceDemandConstants.invalidParameters.businessService
    * call read('../preTests/billingServiceDemandPretest.feature@errorUpdate')
    * print billingServiceDemandResponseBody
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidBusinessService + '[' + billingServiceDemandConstants.invalidParameters.businessService + ']'
...
Scenario: Test to Update Demand with invalid tax head master code
    * call read('../preTests/billingServiceDemandPretest.feature@successCreate')
    * print billingServiceDemandResponseBody
    * eval Demands[0].demandDetails[0].taxHeadMasterCode = billingServiceDemandConstants.invalidParameters.taxHeadMasterCode
    * call read('../preTests/billingServiceDemandPretest.feature@errorUpdate')
    * print billingServiceDemandResponseBody
    * match billingServiceDemandResponseBody.Errors[0].message == billingServiceDemandConstants.expectedMessages.invalidTaxHeadMasterCode + '[' + billingServiceDemandConstants.invalidParameters.taxHeadMasterCode + ']'
...
Scenario: Test to Update Demand with invalid tenant id
    * call read('../preTests/billingServiceDemandPretest.feature@successCreate')
    * print billingServiceDemandResponseBody
    * eval Demands[0].tenantId = commonConstants.invalidParameters.invalidTenantId
    * call read('../preTests/billingServiceDemandPretest.feature@errorUpdate')
    * print billingServiceDemandResponseBody
    * match billingServiceDemandResponseBody.Errors[0].message == commonConstants.errorMessages.invalidTenantIdError
