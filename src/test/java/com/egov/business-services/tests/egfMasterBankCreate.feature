...
@BankCreate_01 @positive @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_UniqueName_02 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_UniqueCode_03 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_InvalidTenant_04 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_NoTenant_05 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_activeNull_06 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_CodeLen_07 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_NameLen_08 @negative @bankCreate @egfMaster @businessServices @regression
...
@Bank_Create_DescLen_09 @negative @bankCreate @egfMaster @businessServices @regression
