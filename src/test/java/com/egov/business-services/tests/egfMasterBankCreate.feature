...
@BankCreate_01 @positive @bank @egfMaster @regression
...
@Bank_Create_UniqueName_02 @negative @bank @egfMaster @regression
...
@Bank_Create_UniqueCode_03 @negative  @bank @egfMaster @regression
...
@Bank_Create_InvalidTenant_04 @negative @bank @egfMaster @regression
...
@Bank_Create_NoTenant_05 @negative @bank @egfMaster @regression
...
@Bank_Create_activeNull_06 @negative @bank @egfMaster @regression
...
@Bank_Create_CodeLen_07 @negative @bank @egfMaster @regression
...
@Bank_Create_NameLen_08 @negative @bank @egfMaster @regression
...
@Bank_Create_DescLen_09 @negative @bank @egfMaster @regression
