...
@Save_01 @positive @businessServicesDontRun @regression @dashboardIngest
...
@Migrate_01 @positive @businessServicesDontRun @regression @dashboardIngest
...
@Upload_ValidFileFormatAndTemplate_01 @positive @businessServicesDontRun @regression @dashboardIngest
...
@Upload_ValidFileFormatAndInvalidTemplate_02 @negative @businessServicesDontRun @regression @dashboardIngest
...
@Upload_InvalidFileFormat_03 @Upload_ValidTemplateAndInvalidFormat_04 @negative @businessServicesDontRun @regression @dashboardIngest
...
@Upload_NoFile_05 @negative @businessServicesDontRun @regression @dashboardIngest
...
@Upload_MultipleFile_06 @Upload_ValidFileWithDifferentName_08 @positive @businessServicesDontRun @regression @dashboardIngest
...
@Upload_DifferentFiles_07 @negative @businessServicesDontRun @regression @dashboardIngest
