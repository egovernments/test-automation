...
@Save_01 @positive @businessServices @regression @dashboardIngest
...
@Migrate_01 @positive @businessServices @regression @dashboardIngest
...
@Upload_ValidFileFormatAndTemplate_01 @positive @businessServices @regression @dashboardIngest
...
@Upload_ValidFileFormatAndInvalidTemplate_02 @negative @businessServices @regression @dashboardIngest
...
@Upload_InvalidFileFormat_03 @Upload_ValidTemplateAndInvalidFormat_04 @negative @businessServices @regression @dashboardIngest
...
@Upload_NoFile_05 @negative @businessServices @regression @dashboardIngest
...
@Upload_MultipleFile_06 @Upload_ValidFileWithDifferentName_08 @positive @businessServices @regression @dashboardIngest
...
@Upload_DifferentFiles_07 @negative @businessServices @regression @dashboardIngest
