Feature: Business Services - Dashboard Analytics service tests
     ...
     * def moduleLevel = dashboardConfig[3].pgr.filterKey
        ...
        @getDashboardConfig_01 @businessServices @positive @dashboardAnalytics
     ...
     * assert dashboardResponseBody.responseData[0].visualizations.length != 0 
        ...
        @getChartV2_metric_01 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.metric
        ...
        @getChartV2_piechart_02 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.pie
        ...
        @getChartV2_bargraph_03 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.line
        ...
        @getChartV2_multiplelinegraph_04 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.line
        ...
        @getChartV2_filter_05 @businessServices @positive @dashboardAnalytics
     ...
     * assert dashboardResponseBody.responseData.filter.length != 0 
        ...
        @getChartV2_timeseries_06 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.line
        ...
        @getChartV2_table_07 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.table
        ...
        @getChartV2_drill_08 @businessServices @positive @dashboardAnalytics
     ...
     * match dashboardResponseBody.responseData.chartType == dashboardServiceData.expected.chartType.table
        ...
        @getChartV2_invalidtenant_09 @businessServices @negative @dashboardAnalytics
