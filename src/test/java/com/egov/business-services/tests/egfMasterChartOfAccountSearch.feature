...
@ChartOfAccountSearch_01  @chartOfAccountSearch  @chartOfAccount  @positive @egfMaster @businessServices
...
@ChartOfAccountSearch_InvalidTenant_02  @chartOfAccountSearch  @chartOfAccount  @negative @egfMaster @businessServices
...
@ChartOfAccountSearch_InvalidType_03  @chartOfAccountSearch  @chartOfAccount  @positive @egfMaster @businessServices
...
@ChartOfAccountSearch_AllRecords_04  @chartOfAccountSearch  @chartOfAccount  @positive @egfMaster @businessServices
...
@ChartOfAccountSearch_TenantIdMandatory_06  @chartOfAccountSearch  @chartOfAccount  @negative @egfMaster @businessServices
