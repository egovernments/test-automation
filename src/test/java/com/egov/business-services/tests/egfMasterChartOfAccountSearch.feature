...
@ChartOfAccountSearch_01  @chartOfAccountSearch  @chartOfAccount  @positive @egfMaster @regression
...
* call read('../../business-services/preTests/egfMasterPreTest.feature@searchAccountSuccessfully')
* match chartOfAccountSearchResponseBody.chartOfAccounts.length == '##[_ > 0]'

@ChartOfAccountSearch_InvalidTenant_02  @chartOfAccountSearch  @chartOfAccount  @negative @egfMaster @regression
...
@ChartOfAccountSearch_InvalidType_03  @chartOfAccountSearch  @chartOfAccount  @positive @egfMaster @regression
...
@ChartOfAccountSearch_AllRecords_04  @chartOfAccountSearch  @chartOfAccount  @positive @egfMaster @regression
Scenario: Verify searching for chart of accounts through API call using tenantId
# Search with only tenantId
* call read('../../business-services/preTests/egfMasterPreTest.feature@searchWithTenantIdSuccessfully')
* match chartOfAccountSearchResponseBody.chartOfAccounts.length == '##[_ > 0]'

@ChartOfAccountSearch_TenantIdMandatory_06  @chartOfAccountSearch  @chartOfAccount  @negative @egfMaster @regression
...
* call read('../../business-services/preTests/egfMasterPreTest.feature@errorInSearchAccount')
