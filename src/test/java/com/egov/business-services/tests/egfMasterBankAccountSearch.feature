...
@BankAccountSearch_01  @positive  @bankAccountSearch  @egfMasterBankAccount @egfMaster @regression @businessServices
...
@BankAccountSearch_InvalidTenant_02  @negative  @bankAccountSearch  @egfMasterBankAccount @egfMaster @regression @businessServices
...
@BankAccountSearch_TenantIdMandatory_03  @negative  @bankAccountSearch  @egfMasterBankAccount @egfMaster @regression @businessServices
...
@BankAccountSearch_AllRecords_05  @positive  @bankAccountSearch  @egfMasterBankAccount @egfMaster @regression @businessServices
