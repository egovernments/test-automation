...
@Bank_Update_01 @positive @bankUpdate @egfMaster @regression
    Scenario: Verify creating bank account throgh API call
        ...
        * call read('../../business-services/pretests/egfMasterPreTest.feature@updateBank')
...
@Bank_Update_UniqueName_02 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_UniqueCode_03 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_InvalidTenant_04 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_NoTenant_05 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_activeNull_06 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_CodeLen_07 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_NameLen_08 @negative @bankUpdate @egfMaster @regression
...
@Bank_Update_DescLen_09 @negative @bankUpdate @egfMaster @regression
