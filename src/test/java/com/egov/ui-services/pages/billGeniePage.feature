Feature: Bill Genie Page Feature

Background:
  * def billGeniePage = read('../../ui-services/page-objects/billGenie.yaml')
  * def bGPO = billGeniePage.objects

  * def jsUtils = read('classpath:jsUtils.js')
	* def bGTestData = billGeniePage.data
  * def getDriverConfig = 
  """
      function(){
          if(browserstack == "yes"){
 ...
 * def getElementText = 
  ...
  * def inputFileUsingJavascript =
  ...
  """
@makePayment_BillGenie
Scenario: login as citizen and make payment of challan generated by employee
  * clickElement(bGPO.billGennieModule)
  * customSelectFromDropdown(bGPO.selectCity , bGTestData.selectCity)
  * customSelectFromDropdown(bGPO.selectServiceCategory , bGTestData.serviceCategory)
  * sendKeys(bGPO.billNumber, billNumber)
  * clickElement(bGPO.searchButton)
  * clickValueInSearchResults(billNumber)
  * clickElement(bGPO.payButton)
  * clickElement(bGPO.makePayment)
