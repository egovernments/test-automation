...
function(){
    ...
    var driverFeature = karate.read('../../ui-services/utils/driver.feature@initializeDriver');
    karate.log(driverFeature);
    karate.call('../../ui-services/utils/driver.feature@initializeDriver');
